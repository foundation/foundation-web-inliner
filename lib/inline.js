...
module.exports = function inline(html, css, options) {
  ...
  // Run the inliner. When it's done, run the success() function below if it worked, or the options.onError() function if there's an error
